...
public class EncryptionServiceTest {
    ...
    @Test
    void testEncryptAccountNumber_DeterministicOutput() throws Exception {
        String sessionId = "test-session";
        String accountNumber = "1234567890";
        String encrypted1 = encryptionService.encryptAccountNumber(sessionId, accountNumber);
        String encrypted2 = encryptionService.encryptAccountNumber(sessionId, accountNumber);
    ...
    @Test
    void testEncryptAccountNumber_DifferentSessionId() throws Exception {
        String accountNumber = "1234567890";
        String encrypted1 = encryptionService.encryptAccountNumber("session1", accountNumber);
        String encrypted2 = encryptionService.encryptAccountNumber("session2", accountNumber);
    ...
    @Test
    void testEncryptAccountNumber_DifferentAccountNumber() throws Exception {
        String sessionId = "test-session";
        String encrypted1 = encryptionService.encryptAccountNumber(sessionId, "1111111111");
        String encrypted2 = encryptionService.encryptAccountNumber(sessionId, "2222222222");
    ...
    @Test
    void testDecryptAccountNumber_CorrectDecryption() throws Exception {
        String sessionId = "test-session";
        String accountNumber = "1234567890";
        String encrypted = encryptionService.encryptAccountNumber(sessionId, accountNumber);
        String decrypted = encryptionService.decryptAccountNumber(sessionId, encrypted);
    ...
    @Test
    void testDecryptAccountNumber_WrongSessionId() throws Exception {
        String sessionId = "test-session";
        String wrongSessionId = "wrong-session";
        String accountNumber = "1234567890";
        String encrypted = encryptionService.encryptAccountNumber(sessionId, accountNumber);
        Exception exception = assertThrows(Exception.class, () -> {
            encryptionService.decryptAccountNumber(wrongSessionId, encrypted);
        });
